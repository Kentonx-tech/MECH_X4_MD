...
const REPO_OWNER = 'MECHX4';
const REPO_NAME = 'MECHX4-MD';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *MECHX4 MD PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/📂 \*MECHX4 MD PLUGINS:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: '𝐌𝐄𝐂𝐇𝐗4 𝐌𝐃 𝐒𝐔𝐏𝐏𝐎𝐑𝐓🍁',
                    serverMessageId: 143
                }
            }
        };
