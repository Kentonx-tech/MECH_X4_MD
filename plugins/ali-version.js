...
cmd({
  ...
  try {
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/MECHX407/MECH_X4_MD';

    // Check update status
    let updateMessage = `*✅ ʏᴏᴜʀ ᴍᴇᴄʜx4 ʙᴏᴛ ɪs ᴜᴘ-ᴛᴏ-ᴅᴀᴛᴇ!*`;
    if (localVersion !== latestVersion) {
      updateMessage = `*😵‍💫 ʏᴏᴜʀ ᴍᴇᴄʜx4 ʙᴏᴛ ɪs ᴏᴜᴛᴅᴀᴛᴇᴅ!*
    ...
    await conn.sendMessage(from, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: '☇ 𝐌𝐄𝐂𝐇𝐗4 𝐒𝐔𝐏𝐎𝐑𝐓 ⃪🤖͎᪳᪳𝆺𝅥',
          serverMessageId: 143
        }
      }
    }, { quoted: mek });
